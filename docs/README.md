...
Reference documentation for intervals-mcp. Start here when a task leaves the
files below; the always-loaded agent context lives in
...
| [api-notes.md](api-notes.md) | Calling the intervals.icu API; record verified behaviour here |
